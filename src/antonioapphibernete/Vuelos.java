...
// Generated 09-dic-2021 10:42:41 by Hibernate Tools 4.3.1
...
public class Vuelos  implements java.io.Serializable {
    ...
    public String toString() {
        return  "\nVUELO: \n"
                +"CODIGO VUELO: " + codVuelo + "\n"
                +"HORA DE SALIDA: " + horaSalida + "\n"
                +"DESTINO: " + destino + "\n"
                +"PROCEDENCIA: " + procedencia + "\n"
                +"PLAZAS FUMADOR: " + plazasFumador + "\n"
                +"PLAZAS NO FUMADOR: " + plazasNoFumador + "\n"
                +"PLAZAS TURISTA: " + plazasTurista + "\n"
                +"PLAZAS PRIMERA: " + plazasPrimera;
    }
